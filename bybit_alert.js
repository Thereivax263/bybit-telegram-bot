sendMessage("? Bot started and running").catch(console.error);
import axios from "axios";
import crypto from "crypto";

const BYBIT_KEY = "KagwKip7bfIfhIKRLq";
const BYBIT_SECRET = "8xQQk8mjoLyhCv6c4RomoPelO7enqB0bZMBn";
const TG_TOKEN = "8226710249:AAG4YuGigDZpVI6HrRj9b7j-5gZFeFn0RfA";
const CHAT_ID = "969254573"; // Exemple : -100123456789
